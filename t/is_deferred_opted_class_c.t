#!/usr/bin/perl -w
#
# User has opted in and isn't whitelisted. Go through the stages of
# being greylisted, then verified.
#
use strict;
use IO::Socket;
use IO::File;
...
$relay_ip = '10.10.20.40';      # Different address, same class c network
...
$relay_ip = '10.10.20.41';      # Different address, same class c network
$curline = "IS_DEFERRED $relay_ip zzyzx\@zzyzx.com micky\@allearsstudios.com";
